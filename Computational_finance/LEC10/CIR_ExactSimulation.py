...
from HestonModelDiscretization import OptionType, ChFHestonModel, CallPutOptionPriceCOSMthd, GeneratePathsHestonEuler, GeneratePathsHestonAES, EUOptionPriceFromMCPathsGeneralized 
...
def mainCalculation():
    ...
    plt.savefig('CIR_ExactSimulation_figure1.png')
