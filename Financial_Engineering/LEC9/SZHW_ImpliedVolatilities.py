...
def A(u,tau,eta,lambd,Rxsigma,Rrsigma,Rxr,gamma,kappa,sigmabar):
    ...
    for k in range(0,len(u)):
       ...
       value1 =integrate.trapezoid(np.real(f),arg)
       value2 =integrate.trapezoid(np.imag(f),arg)
...
def ChFBSHW(u, T, P0T, lambd, eta, rho, sigma):
    ...
    term4 = lambda u:  lambd*integrate.trapezoid(theta(T-zGrid)*C(u,zGrid), zGrid)
